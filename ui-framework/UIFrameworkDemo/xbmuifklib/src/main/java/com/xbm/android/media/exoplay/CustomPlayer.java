...
public class CustomPlayer implements ExoPlayer.Listener, ChunkSampleSource.EventListener,
    ...
    StreamingDrmSessionManager.EventListener, DashChunkSource.EventListener, TextRenderer, MetadataRenderer<List<Id3Frame>>, DebugTextViewHelper.Provider {
  ...
  public interface RendererBuilder {
     ...
     *
     * @param player The player for which renderers are being built. {@link CustomPlayer#onRenderers}
     *     should be invoked once the renderers have been built. If building fails,
     *     {@link CustomPlayer#onRenderersError} should be invoked.
     */
    void buildRenderers(CustomPlayer player);
    /**
     * Cancels the current build operation, if there is one. Else does nothing.
     * <p>
     * A canceled build operation must not invoke {@link CustomPlayer#onRenderers} or
     * {@link CustomPlayer#onRenderersError} on the player, which may have been released.
     */
    void cancel();
  }
   ...
   *
   * @param renderers Renderers indexed by {@link CustomPlayer} TYPE_* constants. An individual
