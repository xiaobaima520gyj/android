 ...
 */
package com.xbm.android.demo.activity.move;
...
import com.xbm.android.demo.adapter.MenuAdapter;
...
/**
 * <p>拖拽Item，侧滑菜单一起使用，是Grid形式的。</p>
 * Created by Yan Zhenjie on 2016/8/3.
 */
public class DragGridMenuActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menuRecyclerView.setLayoutManager(new GridLayoutManager(this, 2));// 布局管理器。
        menuRecyclerView.addItemDecoration(new ListViewDecoration(this));// 添加分割线。
        ...
        menuRecyclerView.setOnItemStateChangedListener(mOnItemStateChangedListener);// 拖拽和侧滑删除时，手指状态监听。
    }
    ...
    private OnItemStateChangedListener mOnItemStateChangedListener = new OnItemStateChangedListener() {
        ...
        public void onSelectedChanged(ViewHolder viewHolder, int actionState) {
            if (actionState == OnItemStateChangedListener.ACTION_STATE_DRAG) {
                ...
                viewHolder.itemView.setBackgroundColor(ContextCompat.getColor(getApplicationContext(), R.color.white_pressed));
                ...
                // 在手松开的时候还原背景。
                ViewCompat.setBackground(viewHolder.itemView, ContextCompat.getDrawable(getApplicationContext(), R.drawable.select_white));
            }
        }
    };
